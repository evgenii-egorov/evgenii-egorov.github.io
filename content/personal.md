...
- Playing chess ([Lichess](https://lichess.org/@/iesh00a)).
- Bikes of different shapes and purposes.
- The smell of a sun-baked field with wormwood, chamomile, and whatever else happens to grow there, where dragonflies fly and the grass is higher than the sky.
- Slavic languages.
- Reading.
- Running when my side has almost started to stitch.

## Dislike!

- Pea porridge.
- When something is done the wrong way.
- The smell of municipal institutions.
- When I behaved differently from how I wanted to.
